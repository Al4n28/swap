...
{
  //float i = 1000, j = 10;
  BOOST_TEST(Calcular_Sueldo(25.0f) == Sol_Calcular_Sueldo(25.0f));
...
{
  //float i = 1000, j = 100;
  BOOST_TEST(Calcular_Sueldo(31.0f) == Sol_Calcular_Sueldo(31.0f));
}
...
{
  //float i = 1000, j = 0;
  BOOST_TEST(Calcular_Sueldo(40.0f) == Sol_Calcular_Sueldo(40.0f));
}

BOOST_AUTO_TEST_CASE( test_case4 )
{
  //float i = 1000, j = 200;
  BOOST_TEST(Calcular_Sueldo(50.0f)==Sol_Calcular_Sueldo(50.0f));
}
...
BOOST_AUTO_TEST_CASE( test_case5 )
{
  ...
  BOOST_TEST(Calcular_Sueldo(0.0f)==Sol_Calcular_Sueldo(0.0f));
}
