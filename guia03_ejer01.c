...
{
  //float i = 1000, j = 10;
  BOOST_TEST(Calcular_Factorial(0) == Sol_Calcular_Factorial(0));
}

BOOST_AUTO_TEST_CASE( test_case2 )
{
  //float i = 1000, j = 100;
  BOOST_TEST(Calcular_Factorial(1) == Sol_Calcular_Factorial(1));
}
...
{
  //float i = 1000, j = 0;
  BOOST_TEST(Calcular_Factorial(5) == Sol_Calcular_Factorial(5));
}

BOOST_AUTO_TEST_CASE( test_case4 )
{
  //float i = 1000, j = 200;
  BOOST_TEST(Calcular_Factorial(2) == Sol_Calcular_Factorial(2));
}

BOOST_AUTO_TEST_CASE( test_case5 )
{
  //float i = 1000.5f, j = 50.5f;
  BOOST_TEST(Calcular_Factorial(3) == Sol_Calcular_Factorial(3));
}
